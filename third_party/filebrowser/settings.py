...
EXTENSIONS = getattr(settings, "FILEBROWSER_EXTENSIONS", {
    ...
    'Video': ['.mov','.wmv','.mpeg','.mpg','.avi','.rm','.webm','.ogv'],
...
VERSIONS = getattr(settings, "FILEBROWSER_VERSIONS", {
    'fb_thumb': {'verbose_name': 'Admin Thumbnail', 'width': 100, 'height': 100, 'opts': 'crop upscale'},
    ...
    'cropped': {'verbose_name': 'Cropped (100x100px)', 'width': 100, 'height': 100, 'opts': 'crop'},
...
MAX_UPLOAD_SIZE = getattr(settings, "FILEBROWSER_MAX_UPLOAD_SIZE", 1048576000)
